                ...
                <div class=" mb-3 grid g-col-12 gap-sm-10 intro-y">
                    <div
                        ...
                        <div
                            ...
                            Total Tamu Hari Ini : {{ $jml_tamu_bupati }}
                        </div>
                        <br>
                        <div id="modal-datepicker">
                            <div class="preview">
                                <div> <a href="javascript:;" data-bs-toggle="modal"
                                        ...
                                        Hari</a> </div>
                                <br>
                                <div> <a href="{{ route('cetak_all-bupati') }}" class="btn btn-danger">Cetak
                                        Seluruh Tamu</a> </div>
                                <div> <a href="{{ route('fe-bupati') }}" class="btn btn-danger mt-5">E-tamu Bupati
                                    </a> </div>
