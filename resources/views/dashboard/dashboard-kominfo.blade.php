...
<head>
    ...
    <link href="{{ asset('images/kominfo.png') }}" rel="shortcut icon">
    ...
    <main class="container">
        <header>
            <div class="title-header col-6">
                <a href="/home"> <img class="logo" src="{{ asset('images/diskominfo/LOGO-DASHBOARD.png') }}" />
                </a>
            </div>
        ...
        <aside>
            <img src="{{ asset('images/diskominfo/kominfo.png') }}" />
        </aside>
