                ...
                <div class=" mb-3 grid g-col-12 gap-sm-10 intro-y">
                    <div
                        ...
                        <div
                            ...
                            Total Tamu Hari Ini : {{ $jml_tamu_setda }}
                        </div>
                        <br>
                        <div id="modal-datepicker">
                            <div class="preview">
                                <div> <a href="javascript:;" data-bs-toggle="modal"
                                        ...
                                        Hari</a> </div>
                                <br>
                                <div> <a href="{{ route('cetak_all-setda') }}" class="btn btn-danger">Cetak
                                        Seluruh Tamu</a> </div>
                                <div> <a href="{{ route('fe-setda') }}" class="btn btn-danger mt-5">E-tamu setda
                                    </a> </div>
                                <div id="datepicker-modal-preview" class="modal fade" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('cetak-setda') }}">
                                                @csrf
